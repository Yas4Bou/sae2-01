...
foreach ($tableau  as $key => $value) {
    ...
    $homePage->appendContent("<div class='movie-items'><a href='http://localhost:8000/moviePage.php?nombre=$id'><img src= 'imageMovie.php?imageID=$posterId' width='100px' height='150px'> <br>$l</a></div>");
}
